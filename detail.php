...
$preference->back_urls = array(
    "success" => "http://mercado.konstela.com/success.php",
    "failure" => "http://mercado.konstela.com/failure.php",
    "pending" => "http://mercado.konstela.com/pending.php"
);
...
<a href="<?php echo $preference->init_point; ?>"><button type='button' class='mercadopago-button' formmethod='post'>Pagar la compra</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
